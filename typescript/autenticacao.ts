// Estrutura dos dados retornados por GET /api/accounts/me/
...
function htmlTogglerNavbar(): string {
...
function renderizarCabecalhoVisitante(): void {
    const cabecalho = document.getElementById("cabecalho");
    if (!cabecalho) return;
...
async function inicializarCabecalho(): Promise<void> {
