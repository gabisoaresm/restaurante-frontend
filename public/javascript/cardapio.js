...
function carregarCarrinho() {
    var _a;
    try {
        return JSON.parse((_a = localStorage.getItem("carrinho")) !== null && _a !== void 0 ? _a : "[]");
    }
    catch (_b) {
        return [];
    }
...
function sincronizarQuantidade(input) {
    ...
    if (qtd > 0) {
        if (idx >= 0)
            ...
            carrinho.push({ id: itemId, nome: itemNome, preco: itemPreco, quantidade: qtd });
    }
    else {
        if (idx >= 0)
        ...
        for (const [catId, { nome: catNome, itens: itensCategoria }] of itensPorCategoria) {
            ...
            for (const item of itensCategoria) {
                ...
                if (tipo === "cliente") {
                    ...
                    const qtdAtual = (_d = (_c = carrinhoAtual.find(i => i.id === item.id)) === null || _c === void 0 ? void 0 : _c.quantidade) !== null && _d !== void 0 ? _d : 0;
                    ...
                    const input = col.querySelector("input[data-item-id]");
                    const btnMais = col.querySelector(".btn-mais");
                    const btnMenos = col.querySelector(".btn-menos");
