...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    const divVisitante = document.getElementById("vista-visitante");
    const divLogada = document.getElementById("vista-logada");
    const divBoasVindas = document.getElementById("boas-vindas");
    const divCards = document.getElementById("cards-dashboard");
    ...
    const nomeBoasVindas = (firstName && firstName.trim()) ? firstName.trim() : (username !== null && username !== void 0 ? username : "");
    if (!token || !tipo) {
    ...
    if (tipo === "cliente") {
        divCards.appendChild(criarCardAcao("cardapio.html", "bi-bag-plus", "Fazer um Pedido", "Navegue pelo cardápio e monte o seu pedido."));
        divCards.appendChild(criarCardAcao("meus-pedidos.html", "bi-receipt", "Meus Pedidos", "Acompanhe e gerencie os seus pedidos."));
